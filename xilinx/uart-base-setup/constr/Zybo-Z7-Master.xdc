...
##Clock signal
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports i_clock_125MHz]

create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports i_clock_125MHz];
#create_generated_clock -name uart_clk -divide_by 5 -source [get_ports { i_clock_125MHz }] [get_pins mmcm0/mmcm2_adv/CLKOUT0];

set_false_path -from [get_pins uart_tx0/reg_tx_reg/C] -to [get_ports o_uart_tx];
set_false_path -from [get_ports i_uart_rx] -to [get_pins reg_uart_rx1_reg/D];
...
##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports o_led_tx]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports o_led_rx]
...
##Pmod Header JC
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports o_seg_a]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports o_seg_b]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports o_seg_c]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports o_seg_d]
...
##Pmod Header JD
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports o_seg_e]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports o_seg_f]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports o_seg_g]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports o_seg_sel]
...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { o_uart_tx }]; #IO_25_35 Sch=je[3]
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { i_uart_rx }]; #IO_L19P_T3_35 Sch=je[4]

set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports i_uart_rx]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports o_uart_tx]
